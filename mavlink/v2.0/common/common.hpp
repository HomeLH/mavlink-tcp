...
enum class MAV_TYPE : uint8_t
{
    ...
    GIMBAL=26, /* Gimbal (standalone) | */
    ADSB=27, /* ADSB system (standalone) | */
    PARAFOIL=28, /* Steerable, nonrigid airfoil | */
    DODECAROTOR=29, /* Dodecarotor | */
    CAMERA=30, /* Camera (standalone) | */
    CHARGING_STATION=31, /* Charging station | */
    FLARM=32, /* FLARM collision avoidance system (standalone) | */
};
...
enum class MAV_COMPONENT
{
    ...
    COMP_ID_GIMBAL=154, /* Gimbal component. | */
...
{
    NAV_WAYPOINT=16, /* Navigate to waypoint. |1: Hold time in decimal seconds. (ignored by fixed wing, time to stay at waypoint for rotary wing)| 2: Acceptance radius in meters (if the sphere with this radius is hit, the waypoint counts as reached)| 3: 0 radius in meters to pass by WP. Positive value for clockwise orbit, negative value for counter-clockwise orbit. Allows trajectory control.| 4: Desired yaw angle at waypoint (rotary wing). NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_LOITER_UNLIM=17, /* Loiter around this waypoint an unlimited amount of time |1: Empty| 2: Empty| 3: Radius around waypoint, in meters. If positive loiter clockwise, else counter-clockwise| 4: red yaw angle.| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_LOITER_TURNS=18, /* Loiter around this waypoint for X turns |1: Turns| 2: Empty| 3: Radius around waypoint, in meters. If positive loiter clockwise, else counter-clockwise| 4: Forward moving aircraft this sets exit xtrack location: 0 for center of loiter wp, 1 for exit location. Else, this is desired yaw angle| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_LOITER_TIME=19, /* Loiter around this waypoint for X seconds |1: Seconds (decimal)| 2: Empty| 3: Radius around waypoint, in meters. If positive loiter clockwise, else counter-clockwise| 4: Forward moving aircraft this sets exit xtrack location: 0 for center of loiter wp, 1 for exit location. Else, this is desired yaw angle| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_RETURN_TO_LAUNCH=20, /* Return to launch location |1: Empty| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    NAV_LAND=21, /* Land at location. |1: de if landing is aborted (0 = undefined/use system default).| 2: Precision land mode.| 3: Empty.| 4: Desired yaw angle. NaN for unchanged.| 5: Latitude.| 6: Longitude.| 7: Landing altitude (ground level in current frame).|  */
    NAV_TAKEOFF=22, /* Takeoff from ground / hand |1: Minimum pitch (if airspeed sensor present), desired pitch without sensor| 2: Empty| 3: Empty| 4: Yaw angle (if magnetometer present), ignored without magnetometer. NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude|  */
    ...
    NAV_PATHPLANNING=81, /* Control autonomous path planning on the MAV. |1: 0: Disable local obstacle avoidance / local path planning (without resetting map), 1: Enable local path planning, 2: Enable and reset local path planning| 2: 0: Disable full path planning (without resetting map), 1: Enable, 2: Enable and reset map/occupancy grid, 3: Enable and reset planned route, but not occupancy grid| 3: Empty| 4: Yaw angle at goal, in compass degrees, [0..360]| 5: Latitude/X of goal| 6: Longitude/Y of goal| 7: Altitude/Z of goal|  */
    NAV_SPLINE_WAYPOINT=82, /* Navigate to waypoint using a spline path. |1: Hold time in decimal seconds. (ignored by fixed wing, time to stay at waypoint for rotary wing)| 2: Empty| 3: Empty| 4: Empty| 5: Latitude/X of goal| 6: Longitude/Y of goal| 7: Altitude/Z of goal|  */
    NAV_VTOL_TAKEOFF=84, /* Takeoff from ground using VTOL mode, and transition to forward flight with specified heading. |1: ty| 2: Front transition heading.| 3: Empty| 4: Yaw angle in degrees. NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_VTOL_LAND=85, /* Land using VTOL mode |1: Empty| 2: Empty| 3: Approach altitude (with the same reference as the Altitude field). NaN if unspecified.| 4: Yaw angle in degrees. NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude (ground level)|  */
    NAV_GUIDED_ENABLE=92, /* hand control over to an external controller |1: 0.5f on)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    NAV_DELAY=93, /* Delay the next navigation command a number of seconds or until a specified time |1: Delay in seconds (decimal, -1 to enable time-of-day fields)| 2: hour (24h format, UTC, -1 to ignore)| 3: minute (24h format, UTC, -1 to ignore)| 4: second (24h format, UTC)| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    NAV_LAST=95, /* NOP - This command is only used to mark the upper limit of the NAV/ACTION commands in the enumeration |1: Empty| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    CONDITION_DELAY=112, /* Delay mission state machine. |1: Delay in seconds (decimal)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    CONDITION_CHANGE_ALT=113, /* Ascend/descend at rate.  Delay mission state machine until desired altitude reached. |1: Descent / Ascend rate (m/s)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Finish Altitude|  */
    CONDITION_DISTANCE=114, /* Delay mission state machine until within desired distance of next NAV point. |1: Distance (meters)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    CONDITION_YAW=115, /* Reach a certain target angle. |1: target angle: [0-360], 0 is north| 2: speed during yaw change:[deg per second]| 3: direction: negative: counter clockwise, positive: clockwise [-1,1]| 4: relative offset or absolute angle: [ 1,0]| 5: Empty| 6: Empty| 7: Empty|  */
    CONDITION_LAST=159, /* NOP - This command is only used to mark the upper limit of the CONDITION commands in the enumeration |1: Empty| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_SET_MODE=176, /* Set system mode. |1: Mode, as defined by ENUM MAV_MODE| 2: ific, please refer to the individual autopilot specifications for details.| 3: Custom sub mode - this is system specific, please refer to the individual autopilot specifications for details.| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_JUMP=177, /* Jump to the desired command in the mission list.  Repeat this action only the specified number of times |1: Sequence number| 2: Repeat count| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_CHANGE_SPEED=178, /* Change speed and/or throttle set points. |1: Speed type (0=Airspeed, 1=Ground Speed, 2=Climb Speed, 3=Descent Speed)| 2: Speed  (m/s, -1 indicates no change)| 3: Throttle  ( Percent, -1 indicates no change)| 4: absolute or relative [0,1]| 5: Empty| 6: Empty| 7: Empty|  */
    DO_SET_HOME=179, /* Changes the home location either to the current location or a specified location. |1: Use current (1=use current location, 0=use specified location)| 2: Empty| 3: Empty| 4: Empty| 5: Latitude| 6: Longitude| 7: Altitude|  */
    DO_SET_PARAMETER=180, /* Set a system parameter.  Caution!  Use of this command requires knowledge of the numeric enumeration value of the parameter. |1: Parameter number| 2: Parameter value| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_SET_RELAY=181, /* Set a relay to a condition. |1: Relay number| 2: Setting (1=on, 0=off, others possible depending on system hardware)| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_REPEAT_RELAY=182, /* Cycle a relay on and off for a desired number of cycles with a desired period. |1: Relay number| 2: Cycle count| 3: Cycle time (seconds, decimal)| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_SET_SERVO=183, /* Set a servo to a desired PWM value. |1: Servo number| 2: PWM (microseconds, 1000 to 2000 typical)| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_REPEAT_SERVO=184, /* Cycle a between its nominal setting and a desired PWM for a desired number of cycles with a desired period. |1: Servo number| 2: PWM (microseconds, 1000 to 2000 typical)| 3: Cycle count| 4: Cycle time (seconds)| 5: Empty| 6: Empty| 7: Empty|  */
    DO_FLIGHTTERMINATION=185, /* Terminate flight immediately |1: 0.5| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_CHANGE_ALTITUDE=186, /* Change altitude set point. |1: Altitude in meters| 2: Mav frame of new altitude (see MAV_FRAME)| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_RALLY_LAND=190, /* Mission command to perform a landing from a rally point. |1: Break altitude (meters)| 2: Landing speed (m/s)| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_GO_AROUND=191, /* Mission command to safely abort an autonomous landing. |1: Altitude (meters)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_REPOSITION=192, /* Reposition the vehicle to a specific WGS84 global position. |1: Ground speed, less than 0 (-1) for default| 2: Bitmask of option flags, see the MAV_DO_REPOSITION_FLAGS enum.| 3: Reserved| 4: Yaw heading, NaN for unchanged. For planes indicates loiter direction (0: clockwise, 1: counter clockwise)| 5: Latitude (deg * 1E7)| 6: Longitude (deg * 1E7)| 7: Altitude (meters)|  */
    DO_PAUSE_CONTINUE=193, /* If in a GPS controlled position mode, hold the current position or continue. |1: and VTOL planes). A plane should loiter with the default loiter radius.| 2: Reserved| 3: Reserved| 4: Reserved| 5: Reserved| 6: Reserved| 7: Reserved|  */
    DO_SET_REVERSE=194, /* Set moving direction to forward or reverse. |1: Direction (0=Forward, 1=Reverse)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_SET_ROI_LOCATION=195, /* Sets the region of interest (ROI) to a location. This can then be used by the vehicles control system to control the vehicle attitude and the attitude of various sensors such as cameras. |1: Empty| 2: Empty| 3: Empty| 4: Empty| 5: Latitude| 6: Longitude| 7: Altitude|  */
    ...
    DO_SET_ROI_NONE=197, /* Cancels any previous ROI command returning the vehicle/sensors to default flight characteristics. This can then be used by the vehicles control system to control the vehicle attitude and the attitude of various sensors such as cameras. |1: Empty| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_CONTROL_VIDEO=200, /* Control onboard camera system. |1: Camera ID (-1 for all)| 2: Transmission: 0: disabled, 1: enabled compressed, 2: enabled raw| 3: 0: single images every n seconds (decimal)| 4: Recording: 0: disabled, 1: enabled compressed, 2: enabled raw| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_MOUNT_CONFIGURE=204, /* Mission command to configure a camera or antenna mount |1: Mount operation mode (see MAV_MOUNT_MODE enum)| 2: stabilize roll? (1 = yes, 0 = no)| 3: stabilize pitch? (1 = yes, 0 = no)| 4: stabilize yaw? (1 = yes, 0 = no)| 5: roll input (0 = angle body frame, 1 = angular rate, 2 = angle absolute frame)| 6: pitch input (0 = angle body frame, 1 = angular rate, 2 = angle absolute frame)| 7: yaw input (0 = angle body frame, 1 = angular rate, 2 = angle absolute frame)|  */
    DO_MOUNT_CONTROL=205, /* Mission command to control a camera or antenna mount |1: pitch depending on mount mode (degrees or degrees/second depending on pitch input).| 2: roll depending on mount mode (degrees or degrees/second depending on roll input).| 3: yaw depending on mount mode (degrees or degrees/second depending on yaw input).| 4: alt in meters depending on mount mode.| 5: latitude in degrees * 1E7, set if appropriate mount mode.| 6: longitude in degrees * 1E7, set if appropriate mount mode.| 7: MAV_MOUNT_MODE enum value|  */
    DO_SET_CAM_TRIGG_DIST=206, /* Mission command to set camera trigger distance for this flight. The camera is triggered each time this distance is exceeded. This command can also be used to set the shutter integration time for the camera. |1: Camera trigger distance (meters). 0 to stop triggering.| 2: Camera shutter integration time (milliseconds). -1 or 0 to ignore| 3: er camera once immediately. (0 = no trigger, 1 = trigger)| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_FENCE_ENABLE=207, /* Mission command to enable the geofence |1: enable? (0=disable, 1=enable, 2=disable_floor_only)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_PARACHUTE=208, /* Mission command to trigger a parachute |1: action| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_MOTOR_TEST=209, /* Mission command to perform motor test |1: motor number (a number from 1 to max number of motors on the vehicle)| 2: throttle type (0=throttle percentage, 1=PWM, 2=pilot throttle channel pass-through. See MOTOR_TEST_THROTTLE_TYPE enum)| 3: throttle| 4: timeout (in seconds)| 5: motor count (number of motors to test to test in sequence, waiting for the timeout above between them; 0=1 motor, 1=1 motor, 2=2 motors...)| 6: motor test order (See MOTOR_TEST_ORDER enum)| 7: Empty|  */
    DO_INVERTED_FLIGHT=210, /* Change to/from inverted flight |1: inverted (0=normal, 1=inverted)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    NAV_SET_YAW_SPEED=213, /* Sets a desired vehicle turn angle and speed change |1: yaw angle to adjust steering by in centidegress| 2: speed - normalized to 0 .. 1| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_MOUNT_CONTROL_QUAT=220, /* Mission command to control a camera or antenna mount, using a quaternion as reference. |1: q1 - quaternion param #1, w (1 in null-rotation)| 2: q2 - quaternion param #2, x (0 in null-rotation)| 3: 3, y (0 in null-rotation)| 4: q4 - quaternion param #4, z (0 in null-rotation)| 5: Empty| 6: Empty| 7: Empty|  */
    DO_GUIDED_MASTER=221, /* set id of master controller |1: System ID| 2: Component ID| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_SET_MISSION_CURRENT=224, /* Set the mission item with sequence number seq as current item. This means that the MAV will continue to this mission item on the shortest path (not following the mission items in-between). |1: Mission sequence value to set| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_LAST=240, /* NOP - This command is only used to mark the upper limit of the DO commands in the enumeration |1: Empty| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    PREFLIGHT_UAVCAN=243, /* Trigger UAVCAN config. This command will be only accepted if in pre-flight mode. |1: 1: Trigger actuator ID assignment and direction mapping.| 2: Reserved| 3: Reserved| 4: Reserved| 5: Reserved| 6: Reserved| 7: Reserved|  */
    ...
    PREFLIGHT_REBOOT_SHUTDOWN=246, /* Request the reboot or shutdown of system components. |1: 0: Do nothing for autopilot, 1: Reboot autopilot, 2: Shutdown autopilot, 3: Reboot autopilot and keep it in the bootloader until upgraded.| 2: 0: Do nothing for onboard computer, 1: Reboot onboard computer, 2: Shutdown onboard computer, 3: Reboot onboard computer and keep it in the bootloader until upgraded.| 3: WIP: 0: Do nothing for camera, 1: Reboot onboard camera, 2: Shutdown onboard camera, 3: Reboot onboard camera and keep it in the bootloader until upgraded| 4: WIP: 0: Do nothing for mount (e.g. gimbal), 1: Reboot mount, 2: Shutdown mount, 3: Reboot mount and keep it in the bootloader until upgraded| 5: Reserved, send 0| 6: Reserved, send 0| 7: WIP: ID (e.g. camera ID -1 for all IDs)|  */
    ...
    MISSION_START=300, /* start running a mission |1: first_item: the first mission item to run| 2: last_item:  the last mission item to run (after this item is run, the mission ends)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    COMPONENT_ARM_DISARM=400, /* Arms / Disarms a component |1: 1 to arm, 0 to disarm| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    GET_HOME_POSITION=410, /* Request the home position from the vehicle. |1: Reserved| 2: Reserved| 3: Reserved| 4: Reserved| 5: Reserved| 6: Reserved| 7: Reserved|  */
    START_RX_PAIR=500, /* Starts receiver pairing |1: 0:Spektrum| 2: RC type (see RC_TYPE enum)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    GET_MESSAGE_INTERVAL=510, /* Request the interval between messages for a particular MAVLink message ID |1: The MAVLink message ID| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    SET_MESSAGE_INTERVAL=511, /* Set the interval between messages for a particular MAVLink message ID. This interface replaces REQUEST_DATA_STREAM |1: The MAVLink message ID| 2: The interval between two messages, in microseconds. Set to -1 to disable and 0 to request default rate.| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    REQUEST_PROTOCOL_VERSION=519, /* Request MAVLink protocol version compatibility |1: 1: Request supported protocol versions by all nodes on the network| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    REQUEST_AUTOPILOT_CAPABILITIES=520, /* Request autopilot capabilities |1: 1: Request autopilot version| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    REQUEST_CAMERA_INFORMATION=521, /* Request camera information (CAMERA_INFORMATION). |1: 0: No action 1: Request camera capabilities| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    REQUEST_CAMERA_SETTINGS=522, /* Request camera settings (CAMERA_SETTINGS). |1: 0: No Action 1: Request camera settings| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    STORAGE_FORMAT=526, /* Format a storage medium. Once format is complete, a STORAGE_INFORMATION message is sent. Use the command's target_component to target a specific component's storage. |1: Storage ID (1 for first, 2 for second, etc.)| 2: 0: No action 1: Format storage| 3: Reserved (all remaining params)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    REQUEST_CAMERA_CAPTURE_STATUS=527, /* Request camera capture status (CAMERA_CAPTURE_STATUS) |1: 0: No Action 1: Request camera capture status| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    REQUEST_FLIGHT_INFORMATION=528, /* Request flight information (FLIGHT_INFORMATION) |1: 1: Request flight information| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    RESET_CAMERA_SETTINGS=529, /* Reset all camera settings to Factory Default |1: 0: No Action 1: Reset all settings| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    SET_CAMERA_ZOOM=531, /* Set camera zoom. Camera must respond with a CAMERA_SETTINGS message (on success). Use NaN for reserved values. |1: Zoom type| 2: Zoom value. The range of valid values depend on the zoom type.| 3: Reserved (all remaining params)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    SET_CAMERA_FOCUS=532, /* Set camera focus. Camera must respond with a CAMERA_SETTINGS message (on success). Use NaN for reserved values. |1: Focus type| 2: Focus value| 3: Reserved (all remaining params)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    JUMP_TAG=600, /* Tagged jump target. Can be jumped to with MAV_CMD_DO_JUMP_TAG. |1: Tag.| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    IMAGE_STOP_CAPTURE=2001, /* Stop image capture sequence Use NaN for reserved values. |1: Reserved (Set to 0)| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    REQUEST_CAMERA_IMAGE_CAPTURE=2002, /* Re-request a CAMERA_IMAGE_CAPTURE message. Use NaN for reserved values. |1: Sequence number for missing CAMERA_IMAGE_CAPTURE message| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    DO_TRIGGER_CONTROL=2003, /* Enable or disable on-board camera triggering system. |1: Trigger enable/disable (0 for disable, 1 for start), -1 to ignore| 2: 1 to reset the trigger sequence, -1 or 0 to ignore| 3: 1 to pause triggering, but without switching the camera off or retracting it. -1 to ignore| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    VIDEO_START_CAPTURE=2500, /* Starts video capture (recording). Use NaN for reserved values. |1: Video Stream ID (0 for all streams)| 2: Frequency CAMERA_CAPTURE_STATUS messages should be sent while recording (0 for no messages, otherwise frequency in Hz)| 3: Reserved (all remaining params)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    VIDEO_STOP_CAPTURE=2501, /* Stop the current video capture (recording). Use NaN for reserved values. |1: Video Stream ID (0 for all streams)| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    VIDEO_START_STREAMING=2502, /* Start video streaming |1: Video Stream ID (0 for all streams, 1 for first, 2 for second, etc.)| 2: Reserved| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    VIDEO_STOP_STREAMING=2503, /* Stop the given video stream |1: Video Stream ID (0 for all streams, 1 for first, 2 for second, etc.)| 2: Reserved| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    REQUEST_VIDEO_STREAM_INFORMATION=2504, /* Request video stream information (VIDEO_STREAM_INFORMATION) |1: Video Stream ID (0 for all streams, 1 for first, 2 for second, etc.)| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    REQUEST_VIDEO_STREAM_STATUS=2505, /* Request video stream status (VIDEO_STREAM_STATUS) |1: Video Stream ID (0 for all streams, 1 for first, 2 for second, etc.)| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    LOGGING_START=2510, /* Request to start streaming logging data over MAVLink (see also LOGGING_DATA message) |1: Format: 0: ULog| 2: Reserved (set to 0)| 3: Reserved (set to 0)| 4: Reserved (set to 0)| 5: Reserved (set to 0)| 6: Reserved (set to 0)| 7: Reserved (set to 0)|  */
    LOGGING_STOP=2511, /* Request to stop streaming log data over MAVLink |1: Reserved (set to 0)| 2: Reserved (set to 0)| 3: Reserved (set to 0)| 4: Reserved (set to 0)| 5: Reserved (set to 0)| 6: Reserved (set to 0)| 7: Reserved (set to 0)|  */
    AIRFRAME_CONFIGURATION=2520, /*  |1: Landing gear ID (default: 0, -1 for all)| 2: Landing gear position (Down: 0, Up: 1, NaN for no change)| 3: Reserved, set to NaN| 4: Reserved, set to NaN| 5: Reserved, set to NaN| 6: Reserved, set to NaN| 7: Reserved, set to NaN|  */
    CONTROL_HIGH_LATENCY=2600, /* Request to start/stop transmitting over the high latency telemetry |1: Control transmission over high latency telemetry (0: stop, 1: start)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    PANORAMA_CREATE=2800, /* Create a panorama at the current position |1: l of the panorama (in degrees, +- 0.5 the total angle)| 2: Viewing angle vertical of panorama (in degrees)| 3: Speed of the horizontal rotation (in degrees per second)| 4: Speed of the vertical rotation (in degrees per second)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    DO_VTOL_TRANSITION=3000, /* Request VTOL transition |1: The target VTOL state, as defined by ENUM MAV_VTOL_STATE. Only MAV_VTOL_STATE_MC and MAV_VTOL_STATE_FW can be used.| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    CONDITION_GATE=4501, /* Delay mission state machine until gate has been reached. |1: Geometry: 0: orthogonal to path between previous and next waypoint.| 2: Altitude: 0: ignore altitude| 3: Empty| 4: Empty| 5: Latitude| 6: Longitude| 7: Altitude|  */
    ...
    PAYLOAD_CONTROL_DEPLOY=30002, /* Control the payload deployment. |1: Operation mode. 0: Abort deployment, continue normal mission. 1: switch to payload deployment mode. 100: delete first payload deployment request. 101: delete all payload deployment requests.| 2: Reserved| 3: Reserved| 4: Reserved| 5: Reserved| 6: Reserved| 7: Reserved|  */
    WAYPOINT_USER_1=31000, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    WAYPOINT_USER_2=31001, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    WAYPOINT_USER_3=31002, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    WAYPOINT_USER_4=31003, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    WAYPOINT_USER_5=31004, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    SPATIAL_USER_1=31005, /* User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    SPATIAL_USER_2=31006, /* User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    SPATIAL_USER_3=31007, /* User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    SPATIAL_USER_4=31008, /* User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item. |1: User defined| 2: er defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    SPATIAL_USER_5=31009, /* User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
    USER_1=31010, /* User defined command. Ground Station will not show the Vehicle as flying through this item. Example: MAV_CMD_DO_SET_PARAMETER item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: User defined| 6: User defined| 7: User defined|  */
    USER_2=31011, /* User defined command. Ground Station will not show the Vehicle as flying through this item. Example: MAV_CMD_DO_SET_PARAMETER item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: User defined| 6: User defined| 7: User defined|  */
    USER_3=31012, /* User defined command. Ground Station will not show the Vehicle as flying through this item. Example: MAV_CMD_DO_SET_PARAMETER item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: User defined| 6: User defined| 7: User defined|  */
    USER_4=31013, /* User defined command. Ground Station will not show the Vehicle as flying through this item. Example: MAV_CMD_DO_SET_PARAMETER item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: User defined| 6: User defined| 7: User defined|  */
    USER_5=31014, /* User defined command. Ground Station will not show the Vehicle as flying through this item. Example: MAV_CMD_DO_SET_PARAMETER item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: User defined| 6: User defined| 7: User defined|  */
};
...
{
    OK=1, /* Command / mission item is ok. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ERR_FAIL=2, /* Generic error message if none of the other reasons fails or if no detailed error reporting is implemented. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ERR_ACCESS_DENIED=3, /* The system is refusing to accept this command from this source / communication partner. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ERR_NOT_SUPPORTED=4, /* Command or mission item is not supported, other commands would be accepted. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ERR_COORDINATE_FRAME_NOT_SUPPORTED=5, /* The coordinate frame of this command / mission item is not supported. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    ERR_X_LAT_OUT_OF_RANGE=7, /* The X or latitude value is out of range. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ERR_Y_LON_OUT_OF_RANGE=8, /* The Y or longitude value is out of range. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ERR_Z_ALT_OUT_OF_RANGE=9, /* The Z or altitude value is out of range. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
};
...
constexpr auto CAMERA_ZOOM_TYPE_ENUM_END = 3;
...
constexpr auto SET_FOCUS_TYPE_ENUM_END = 3;
