...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_CONDITION_CHANGE_ALT=113, /* Ascend/descend at rate.  Delay mission state machine until desired altitude reached. |1: Descent / Ascend rate (m/s)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Finish Altitude|  */
   ...
   MAV_CMD_DO_SET_RELAY=181, /* Set a relay to a condition. |1: Relay number| 2: Setting (1=on, 0=off, others possible depending on system hardware)| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
   MAV_CMD_DO_REPEAT_RELAY=182, /* Cycle a relay on and off for a desired number of cycles with a desired period. |1: Relay number| 2: Cycle count| 3: Cycle time (seconds, decimal)| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
   MAV_CMD_DO_SET_SERVO=183, /* Set a servo to a desired PWM value. |1: Servo number| 2: PWM (microseconds, 1000 to 2000 typical)| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
   ...
   MAV_CMD_COMPONENT_ARM_DISARM=400, /* Arms / Disarms a component |1: 1 to arm, 0 to disarm| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   ...
   MAV_CMD_START_RX_PAIR=500, /* Starts receiver pairing |1: 0:Spektrum| 2: RC type (see RC_TYPE enum)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
